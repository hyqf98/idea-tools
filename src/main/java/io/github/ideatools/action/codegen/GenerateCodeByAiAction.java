package io.github.ideatools.action.codegen;
...
import io.github.ideatools.service.codegen.CodeGenService;
import io.github.ideatools.ui.config.CodeGenConfigState;
...
public class GenerateCodeByAiAction extends AnAction {
    ...
    private static class CodeGenDialog extends DialogWrapper {
        ...
        private void loadTables() {
            ...
            try {
                io.github.ideatools.service.database.DatabaseMetadataService dbService = 
                        new io.github.ideatools.service.database.DatabaseMetadataService();
